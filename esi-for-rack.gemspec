...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::RubyGemsVersion) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<esi_attribute_language>, [">= 0"])
      s.add_runtime_dependency(%q<nokogiri>, [">= 0"])
      s.add_runtime_dependency(%q<spy-vs-spy>, [">= 0"])
      s.add_runtime_dependency(%q<dirge>, [">= 0"])
    else
      s.add_dependency(%q<esi_attribute_language>, [">= 0"])
      s.add_dependency(%q<nokogiri>, [">= 0"])
      s.add_dependency(%q<spy-vs-spy>, [">= 0"])
      s.add_dependency(%q<dirge>, [">= 0"])
    end
  else
    s.add_dependency(%q<esi_attribute_language>, [">= 0"])
    s.add_dependency(%q<nokogiri>, [">= 0"])
